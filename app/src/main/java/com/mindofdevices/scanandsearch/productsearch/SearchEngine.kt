...
package com.mindofdevices.scanandsearch.productsearch
...
class SearchEngine(context: Context) {
    ...
    fun search(
        ...
        Tasks.call<JsonObjectRequest>(requestCreationExecutor, Callable { createRequest(detectedObject) })
            ...
            .addOnFailureListener { e ->
                ...
                val list: MutableList<DetectedObject.Label> = ArrayList()
                list.addAll(detectedObject.labels)
                if(list.isEmpty()){
                    for (i in 0..7) {
                        productList.add(
                                Product(/* imageUrl= */"https://images-na.ssl-images-amazon.com/images/I/71WuDXpTAlL._SL1500_.jpg", "Asus vivo $i", "Intel Quad Core Pentium Silver N5030, 14-inch FHD Thin and Light Laptop (4GB RAM/1TB HDD/Windows 10/Integrated...$i")
                        )
                    }
                }else{
                for (i in 0..7) {
                    productList.add(
                        Product(/* imageUrl= */"https://images-na.ssl-images-amazon.com/images/I/71WuDXpTAlL._SL1500_.jpg", list[i].text, "Intel Quad Core Pentium Silver N5030, 14-inch FHD Thin and Light Laptop (4GB RAM/1TB HDD/Windows 10/Integrated...$i")
                    )
                }
                }
    ...
    companion object {
        ...
        private fun createRequest(searchingObject: DetectedObjectInfo): JsonObjectRequest {
            ...
            return JsonObjectRequest(Request.Method.GET, imageUrl, null,
                    { response ->
