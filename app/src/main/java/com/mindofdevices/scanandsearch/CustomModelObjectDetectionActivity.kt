...
import com.mindofdevices.scanandsearch.barcodedetection.BarcodeProcessor
...
import com.mindofdevices.scanandsearch.productsearch.Product
...
class CustomModelObjectDetectionActivity : AppCompatActivity(), OnClickListener {
    ...
    private fun setUpWorkflowModel() {
        workflowModel = ViewModelProviders.of(this).get(WorkflowModel::class.java).apply {
            ...
            objectToSearch.observe(this@CustomModelObjectDetectionActivity, Observer {  detectObject: DetectedObjectInfo ->
            ...
            searchedObject.observe(this@CustomModelObjectDetectionActivity, Observer { searchedObject:SearchedObject ->
