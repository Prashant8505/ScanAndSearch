...
import com.midofdevices.scanandsearch.*
...
class MainActivity : AppCompatActivity() {
    ...
    private enum class DetectionMode(val titleResId: Int, val subtitleResId: Int) {
        ...
        TEXT_REC_LIVE(R.string.mode_textReco_live_title, R.string.mode_textReco_live_subtitle)
            ...
            internal fun bindDetectionMode(detectionMode: DetectionMode) {
                ...
                itemView.setOnClickListener {
                    ...
                    when (detectionMode) {
                        ...
                        DetectionMode.TEXT_REC_LIVE ->
                            activity.startActivity(Intent(activity, TextRecognition::class.java))
